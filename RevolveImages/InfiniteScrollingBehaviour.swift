...
public struct CollectionViewConfiguration {
    ...
    public static let `default` = CollectionViewConfiguration(layoutType: .numberOfCellOnScreen(3), scrollingDirection: .horizontal)
...
public class InfiniteScrollingBehaviour: NSObject {
    ...
    fileprivate(set) public var contentOffsetForCollectionView:CGPoint
    fileprivate(set) public weak var collectionView: UICollectionView!
    fileprivate(set) public weak var scrollViewTemp: UIScrollView!
    ...
    public init(withCollectionView collectionView: UICollectionView, andData dataSet: [InfiniteScollingData], delegate: InfiniteScrollingBehaviourDelegate, configuration: CollectionViewConfiguration = .default) {
        ...
        self.contentOffsetForCollectionView = self.collectionView.contentOffset
        super.init()
...
extension InfiniteScrollingBehaviour: UICollectionViewDelegateFlowLayout {
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if contentOffsetValue >= (scrollViewContentSizeValue - boundarySize) {
            ...
            self.contentOffsetForCollectionView = updatedOffsetPoint
...
//            self.contentOffsetForCollectionView = updatedOffsetPoint
    ...
    public func updateScrolViewOffSet(){
        scrollViewTemp.contentOffset = CGPoint.init(x: 0, y: 300)
        self.contentOffsetForCollectionView = CGPoint.init(x: 0, y: 300)
    }
